class GerenteRouter(object): 
    def db_for_read(self, model, **hints):
        "Point all operations on gerente models to 'redminedb'"
    ...
    def allow_relation(self, obj1, obj2, **hints):
        "Allow any relation if a both models in gerente app"
        if obj1._meta.app_label == 'gerente' and obj2._meta.app_label == 'gerente':
            return True
        # Allow if neither is gerente app
